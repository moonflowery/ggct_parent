...
package com.ch.ggct.live.mtcloud;

import com.ch.ggct.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "51313";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "7dbd7dfbbf397856bc19527f7b17b0de";
